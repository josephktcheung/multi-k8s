...
kubectl set image deployments/client-deployment server=josephktcheung/multi-client:$SHA
kubectl set image deployments/worker-deployment server=josephktcheung/multi-worker:$SHA
